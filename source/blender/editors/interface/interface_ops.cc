...
#include "BKE_fcurve.hh"/*bfa - goo engine - Show FCurve in editor operator patch*/
#include "ED_anim_api.hh"/*bfa - goo engine - Show FCurve in editor operator patch*/
...
void ED_operatortypes_ui()
{
  ...
  WM_operatortype_append(UI_OT_show_fcurve_in_editor);/*bfa - goo engine - Show FCurve in editor operator patch*/
