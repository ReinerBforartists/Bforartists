...
class TOPBAR_HT_tool_bar(Header):
    ...
    def draw(self, context):
        ...
        layout.popover(panel="TOPBAR_PT_type", text = "")
...
# bfa - show hide the editortype menu - can't  use here!

########################################################################

############################### Toolbar Type Panel ########################################

class TOPBAR_PT_type(Panel):
...
class TOPBAR_PT_menu_file(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'HEADER'
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_load_save")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_recover")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_link_append")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_import_menu")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_export_menu")

        col = layout.column(align = True)
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_import_common")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_import_common2")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_import_uncommon")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_export_common")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_export_common2")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_export_uncommon")

        col = layout.column(align = True)
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_render")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_render_opengl")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_file_render_misc")
...
class TOPBAR_MT_file(Menu):
    ...
    def draw_menus(layout, context):
        ...
        layout.popover(panel="TOPBAR_PT_menu_file", text = "")
        ...
        if addon_prefs.topbar_file_import_uncommon:
            ...
            row.operator("wm.stl_ply", text="", icon='LOAD_PLY')
        ...
        if addon_prefs.topbar_file_export_uncommon:
            ...
            row.operator("wm.ply_import", text="", icon='SAVE_PLY')
...
class TOPBAR_PT_menu_meshedit(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'HEADER'
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_vertices_splitconnect")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_vertices_misc")

        col = layout.column(align = True)
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_edges_subdiv")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_edges_sharp")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_edges_freestyle")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_edges_misc")

        col = layout.column(align = True)
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_faces_general")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_faces_freestyle")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_faces_tris")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_faces_rotatemisc")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_mesh_cleanup")
...
class TOPBAR_MT_meshedit(Menu):
    ...
    def draw_menus(layout, context):
        ...
        layout.popover(panel="TOPBAR_PT_menu_meshedit", text = "")
...
class TOPBAR_PT_menu_primitives(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'HEADER'
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_mesh")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_curve")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_surface")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_metaball")

        col = layout.column(align = True)
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_volume")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_point_cloud")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_gpencil")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_gpencil_lineart")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_light")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_other")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_empties")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_image")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_lightprobe")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_forcefield")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_primitives_collection")
...
class TOPBAR_MT_primitives(Menu):
    ...
    def draw_menus(layout, context):
        ...
        layout.popover(panel="TOPBAR_PT_menu_primitives", text = "")
...
class TOPBAR_MT_image(Menu):
    ...
    def draw_menus(layout, context):
        ...
        layout.popover(panel="TOPBAR_PT_menu_image", text = "")
...
class TOPBAR_PT_menu_tools(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'HEADER'
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_parent")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_objectdata")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_link_to_scn")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_linked_objects")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_join")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_origin")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_shading")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_datatransfer")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_tools_relations")
...
class TOPBAR_MT_tools(Menu):
    ...
    def draw_menus(layout, context):
        ...
        layout.popover(panel="TOPBAR_PT_menu_tools", text = "")
...
class TOPBAR_PT_menu_animation(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'HEADER'
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_animation_keyframes")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_animation_play")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_animation_range")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_animation_keyframetype")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_animation_sync")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_animation_keyingset")
...
class TOPBAR_MT_animation(Menu):
    ...
    def draw_menus(layout, context):
        ...
        layout.popover(panel="TOPBAR_PT_menu_animation", text = "")
...
class TOPBAR_PT_menu_edit(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'HEADER'
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_edit_edit")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_edit_weightinedit")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_edit_objectapply")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_edit_objectapply2")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_edit_objectapplydeltas")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_edit_objectclear")
...
class TOPBAR_MT_edit(Menu):
    ...
    def draw_menus(layout, context):
        ...
        layout.popover(panel="TOPBAR_PT_menu_edit", text = "")
...
class TOPBAR_PT_menu_misc(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'HEADER'
    ...
    def draw(self, context):
        ...
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_viewport")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_undoredo")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_undohistory")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_repeat")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_scene")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_viewlayer")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_last")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_operatorsearch")
        row = col.row()
        row.separator()
        row.prop(addon_prefs, "topbar_misc_info")
...
class TOPBAR_MT_misc(Menu):
    ...
    def draw_menus(layout, context):
        ...
        layout.popover(panel="TOPBAR_PT_menu_misc", text = "")
...
classes = [
    ...
    TOPBAR_PT_menu_animation,
    TOPBAR_PT_menu_tools,
    TOPBAR_PT_menu_image,
    TOPBAR_PT_menu_primitives,
    TOPBAR_PT_menu_meshedit,
    # TOPBAR_MT_image_uv_rotate_clockwise,
    # TOPBAR_MT_image_uv_rotate_counterclockwise,
    # TOPBAR_MT_image_uv_mirror_x,
    # TOPBAR_MT_image_uv_mirror_y,
]
