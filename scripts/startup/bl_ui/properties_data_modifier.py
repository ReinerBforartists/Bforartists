...
classes = (
    ...
    OBJECT_MT_modifier_add_assets,#BFA - new properties editor add menus
    OBJECT_MT_modifier_add_edit_assets, #BFA - new properties editor add menus
    OBJECT_MT_modifier_add_generate_assets, #BFA - new properties editor add menus
    OBJECT_MT_modifier_add_deform_assets, #BFA - new properties editor add menus
    OBJECT_MT_modifier_add_physics_assets, #BFA - new properties editor add menus
    OBJECT_MT_modifier_add_color_assets, #BFA - new properties editor add menus
    OBJECT_OT_add_asset_modifier_menu, #BFA - new properties editor add menus
