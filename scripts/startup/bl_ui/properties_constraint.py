...
from bl_ui.generic_column_menu import GenericColumnMenu, fetch_op_data, InvokeMenuOperator #BFA - new properties editor add menus
...
class OBJECT_PT_constraints(ObjectConstraintPanel, Panel):
    ...
    def draw(self, _context):
        layout = self.layout
        layout.operator("object.add_constraints_menu", icon='ADD') #BFA - new properties editor add menus
...
class BONE_PT_constraints(BoneConstraintPanel, Panel):
    ...
    def draw(self, _context):
        layout = self.layout
        layout.operator("bone.add_constraints_menu", icon='ADD') #BFA - new properties editor add menus

        layout.template_constraints(use_bone_constraints=True) #BFA - new properties editor add menus
...
classes = (
    ...
    OBJECT_MT_constraint_add, #BFA - new properties editor add menus
    OBJECT_OT_add_constraints_menu, #BFA - new properties editor add menus
    BONE_PT_constraints,
    BONE_MT_constraint_add, #BFA - new properties editor add menus
    BONE_OT_add_constraints_menu, #BFA - new properties editor add menus
